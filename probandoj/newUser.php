...
if($existe = @mysql_fetch_object($query)){
	...
	$insertar = @mysql_query("INSERT INTO usuarios (usu_codigo, usu_nombre, usu_password, usu_email) values ('$user', '$nombre', '$pass', '$userMail')");
		echo $insertar;
		echo "INSERT INTO usuarios (usu_codigo, usu_nombre, usu_pass, usu_email) values ('$user', '$nombre', '$pass', '$userMail')";
		echo "<br>";
		echo $user." ".$userName." ".$userSur." ".$pass." ".$userMail; 
		echo "<br>Registro correcto. Recibir$acutea; un email cuando el administrador active su cuenta.";
}
