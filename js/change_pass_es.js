$(function() {
    ...
    function changePass() {
      if(!document.getElementById('old_pass').value){
        document.getElementById('span_old_pass').innerHTML='Campo obligatorio';
      } else {
        document.getElementById('span_old_pass').innerHTML='';
        if(!document.getElementById('new_pass1').value){
          document.getElementById('span_new_pass1').innerHTML='Campo obligatorio';
        } else {
          document.getElementById('span_new_pass1').innerHTML='';
          if(!document.getElementById('new_pass2').value){
            document.getElementById('span_new_pass2').innerHTML='Campo obligatorio';
          } else {
    ...
    dialog = $( "#dialog-form" ).dialog({
      ...
      modal: true,
      buttons: {
        "Cambiar mi contraseña": changePass,
        Cancelar: function() {
          dialog.dialog( "close" );
        }
      },
